...
- 当前 final proof-wave 计划：[`2026-04-04-final-architecture-consistency-proof-plan.md`](./2026-04-04-final-architecture-consistency-proof-plan.md)
...
- 历史归档入口：[`../archive/plans/README.md`](../archive/plans/README.md)

## Historical Context

- 已退出 active spine 的 dated execution / remediation / technical-debt plans 已迁入 [`../archive/plans/README.md`](../archive/plans/README.md)。
- 历史 closure reports 和 batch reports 继续保留，但只通过 archive 索引进入。
