...
def test_distribution_build_creates_generated_outputs(tmp_path) -> None:
    ...
    assert bundle_payload['release']['version'] == '4.1.0'
    ...
    assert bundle_payload['asset']['file_name'] == 'vibe-skills-4.1.0-public.zip'
    ...
    asset_root = tmp_path / 'bundle-out' / 'vibe-skills-4.1.0-public'
    asset_zip = tmp_path / 'bundle-out' / 'vibe-skills-4.1.0-public.zip'
