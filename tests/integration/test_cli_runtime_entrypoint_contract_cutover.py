    ...
    for host_id in SUPPORTED_HOSTS:
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            no_specialist_needed = (
                ...
                and specialist_decision.get("resolution_mode") == "no_specialist_needed"
            )
            assert len(runtime_packet["specialist_recommendations"]) >= 1 or no_specialist_needed, host_id
