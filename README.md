...
**项目持续整合并治理 superpower、claude-scientific-skills、get-shit-done、aios-core、OpenSpec、ralph-claude-code、SuperClaude_Framework 等优秀项目，把它们在提示组织、技能沉淀、计划驱动、治理执行、科研辅助和工程协作上的优势吸收进同一套系统里。感谢各个仓库作者的无私奉献，没有他们就没有Vibe-Skills的诞生。**
