...
function Invoke-SupportedHostRuntimeTruthProbe {
    ...
    try {
        ...
        Add-Assertion -Assertions $Assertions -Pass (($specialistRecommendationCount -ge 1) -or $noSpecialistNeeded) -Message "$HostId runtime-input-packet preserves specialist recommendation or explicit no-specialist evidence"
